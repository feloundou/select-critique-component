...
# def my_component(critique_clicked=None, ai_response=None, ai_responses=None, key=None):
#     component_value = _component_func(
#         critique_clicked=critique_clicked, ai_response=ai_response, ai_responses=ai_responses, key=key, default={}
#     )
...
#     st.session_state.ai_responses[f"L{response['level'] + 1}I{response['index'] * 2 + 1}"] = model_response["choices"][0]["message"]["content"]
#     st.session_state.critique_clicked = True
...
if response and response.get("critique_clicked", False):
    ...
    st.session_state.ai_responses[f"L{response['level'] + 1}I{response['index'] * 2 + 1}"] = model_response["choices"][0]["message"]["content"]
    print("ai_response")
    print(st.session_state.get("model_response_str", ""))

    # ai_responses[(level, index)] = model_response["choices"][0]["message"]["content"]
